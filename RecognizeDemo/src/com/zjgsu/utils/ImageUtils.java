...
public class ImageUtils {
	...
	public static final int EXPANDNUM = 20;        // 膨胀系数
	 ...
	 * @return
	 */
	public Bitmap TiltCorrection(Bitmap binaryBitmap) {
	...
	public Bitmap expand(Bitmap binaryBitmap) {
		int width  = binaryBitmap.getWidth();
		int height = binaryBitmap.getHeight();
	 ...
	 * @return
	 */
	private int calRatate(Bitmap myBitmap) {
		int width = myBitmap.getWidth();
		int height = myBitmap.getHeight();
		//最长距离
